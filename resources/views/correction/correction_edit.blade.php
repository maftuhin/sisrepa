...
<form method="POST" action="/correction/update/{{$id}}">
    ...
    <div class="card-body">
        <table class="form-group table-sm" style="width: 100%;">
            ...
            <tr>
                <td>Jumlah</td>
                <td><input type="text" class="form-control" placeholder="Jumlah" name="ppn_jumlah" value="{{$data->c_ppn_jumlah}}" id="currency"></td>
            </tr>
            <tr>
                <td>NTPN</td>
            ...
            <tr>
                <td>Jumlah</td>
                <td><input type="text" class="form-control" placeholder="Jumlah" name="pph21_jumlah" value="{{$data->c_pph21_jumlah}}" id="currency"></td>
            </tr>
            <tr>
                <td>NTPN</td>
            ...
            <tr>
                <td>Jumlah</td>
                <td><input type="text" class="form-control" placeholder="Jumlah" name="pph22_jumlah" value="{{$data->c_pph22_jumlah}}" id="currency"></td>
            </tr>
            <tr>
                <td>NTPN</td>
            ...
            <tr>
                <td>Jumlah</td>
                <td><input type="text" id="currency" class="form-control" placeholder="Jumlah" name="pph23_jumlah" value="{{$data->c_pph23_jumlah}}"></td>
            </tr>
            <tr>
                <td>NTPN</td>
            ...
            <tr>
                <td>Jumlah</td>
                <td><input type="text" class="form-control" placeholder="Jumlah" name="pphfin_jumlah" id="currency" value="{{$data->c_pphfin_jumlah}}"></td>
            </tr>
            <tr>
                <td>NTPN</td>
